    ...
    function addBreaks(list) {
        ...
        for (var i = 0; i < list.length - 1; i++) {
            ...
            if (differenceTime >= 40 && (start > time || end <= time)) {
                ...
                $(list[i]).after("<li class=\"fantom-break " + disabledClass + "\"><div class=\"time-info\">" + "<div class=\"info\">Перерыв " + getDiffTime(difH, difM) + "</div>" + "<div class=\"desc\"></div></div></li>");
            }
        }
    ...
    function setDate() {
        ...
        if (pereriv >= 40 && pereriv < 200) {
            if (minDiffFromTime > 10) {
                $(selected_item).before("<li class=\"break ftwo\"><div class=\"time-info\">" + "<div class=\"info\">Перерыв " + getDiffTime(hourDiff, minutsDiff) + "т</div>" + "<div class=\"desc\">Воспользуйтесь общественным транспортом &#10095</div></div></li>");
